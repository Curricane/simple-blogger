...
import (
	...
	"github.com/Curricane/blogger/logic"
	"github.com/Curricane/blogger/util"
...
func IndexHandle(c *gin.Context) {
	...
	if err != nil {
		fmt.Printf("get categoru list failed, err:%v\n", err)
	}
...
func CategoryList(c *gin.Context) {
	...
	if err != nil {
		fmt.Print("get article  failed, err:%v\n", err)
		c.HTML(http.StatusInternalServerError, "views/500.html", nil)
		return
	}
...
func LeaveNew(c *gin.Context) {
	...
	if err != nil {
		fmt.Printf("get leave failed, err:%v", err)
		c.HTML(http.StatusInternalServerError, "views/500.html", nil)
		return
	}
...
func ArticleDetail(c *gin.Context) {
	...
	//想模版里传多个数据结构，需要用到map map[string]interface{}
